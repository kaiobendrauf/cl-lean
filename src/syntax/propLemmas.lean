...
lemma MP' {form: Type} {ft: formula form} {φ ψ : form} (hL: ft.ax φ) (hImp: ft.ax (ft.imp φ ψ)) : ft.ax (ψ) :=
begin
 apply ft.mp,
 exact hImp,
 exact hL,
...
lemma prtrue {form: Type} {ft: formula form}: ft.ax (ft.not ft.bot) := 
begin
  rw ft.notdef,
  exact iden,
end

lemma topnotbot {form: Type} {ft: formula form}: ft.top = ft.not ft.bot :=
begin
...
lemma dni {form: Type} {ft: formula form} {φ : form} : ft.ax (ft.imp φ (ft.not (ft.not φ))) :=
begin
exact ft.mp _ _ (ft.p7 _ _) dne
end


lemma imp_if_imp_imp {form: Type} {ft: formula form} {φ ψ χ : form} : ft.ax (ft.imp φ χ) → ft.ax (ft.imp φ (ft.imp ψ χ)) :=
begin
intro h1,
...
lemma imp_switch {form: Type} {ft: formula form} {φ ψ χ : form} : ft.ax (ft.imp φ (ft.imp ψ χ)) → ft.ax (ft.imp ψ (ft.imp φ χ)) :=
begin
intro h1,
...
lemma l2 {form: Type} {ft: formula form} {φ ψ χ : form} : ft.ax (ft.imp (ft.imp φ (ft.imp ψ χ)) (ft.imp ψ (ft.imp φ χ))) :=
begin
...
lemma phi_and_true {form: Type} {ft: formula form} {φ : form} : ft.ax (ft.iff (ft.and φ (ft.not ft.bot)) φ) :=
begin
rw ft.iffdef at *,
exact (ft.mp _ _ (ft.mp _ _ (ft.p4 _ _) (ft.p5 _ _)) (ft.mp _ _ (imp_switch (ft.p4 _ _)) prtrue))
end

lemma phi_and_true' {form: Type} {ft: formula form} {φ : form} : ft.ax (ft.and (ft.imp (ft.and φ (ft.not ft.bot)) φ) (ft.imp φ (ft.and φ (ft.not ft.bot)))) :=
begin
exact (ft.mp _ _ (ft.mp _ _ (ft.p4 _ _) (ft.p5 _ _)) (ft.mp _ _ (imp_switch (ft.p4 _ _)) prtrue))
end
...
begin
rw ft.iffdef at *,
exact (ft.mp _ _ (ft.mp _ _ (ft.p4 _ _) (ft.mp _ _ (ft.p1 _ _) prtrue)) (ft.mp _ _ (ft.p1 _ _) not_contra))
end
...
lemma and_switch {form: Type} {ft: formula form} {φ ψ : form} : ft.ax (ft.iff (ft.and φ ψ) (ft.and ψ φ)) :=
begin
rw ft.iffdef at *,
...
lemma and_switch' {form: Type} {ft: formula form} {φ ψ : form} : ft.ax (ft.and (ft.imp (ft.and ψ φ) (ft.and φ ψ))(ft.imp (ft.and φ ψ) (ft.and ψ φ))) :=
begin
...
lemma and_commute {form: Type} {ft: formula form} {φ ψ χ : form} : ft.ax (ft.iff (ft.and (ft.and φ ψ) χ) (ft.and φ (ft.and ψ χ))) :=
begin
rw ft.iffdef at *,
...
lemma and_commute' {form: Type} {ft: formula form} {φ ψ χ : form} : ft.ax (ft.and (ft.imp (ft.and (ft.and φ ψ) χ) (ft.and φ (ft.and ψ χ))) (ft.imp (ft.and φ (ft.and ψ χ)) (ft.and (ft.and φ ψ) χ))) :=
begin
exact ft.mp _ _ (ft.mp _ _ (ft.p4 _ _) (ft.mp _ _ double_imp (imp_imp_iff_imp.mp 
 (cut (cut (ft.p5 _ _) (ft.p6 _ _)) (cut2 (ft.p6 _ _) (cut1 (ft.p4 _ _) (imp_switch (cut (cut (ft.p5 _ _) (ft.p5 _ _)) (ft.p4 _ _))))))))) 
 (ft.mp _ _ double_imp (imp_imp_iff_imp.mp (cut (cut (ft.p6 _ _) (ft.p5 _ _)) 
...
-- lemma demorgans {form: Type} {ft: formula form} {φ ψ : form} : ft.ax (ft.not (ft.and φ ψ)) ↔ ft.ax (ft.imp φ (ft.not ψ)) :=
-- begin
-- split,
-- intro h1,
-- have htemp': _, from ft.p5 _ _,
-- have htemp: _, from ft.mp _ _ (ft.p5 _ _),
-- exact (and_right_imp.mp (ft.mp _ _ (contrapos.mpr (ft.mp _ _ (ft.p5 _ _) and_switch)) h1)),
-- -- exact (and_right_imp.mp (ft.mp _ _ (contrapos.mpr (ft.mp _ _ (ft.p5 _ _) and_switch)) h1)),

-- intro h1,
-- exact (ft.mp _ _ (contrapos.mpr (ft.mp _ _ (ft.p5 _ _) and_switch)) (and_right_imp.mpr h1))
-- end



-- lemma explosion {ψ : form} : ft.ax (⊥ ~> ψ) :=
-- begin
-- apply contrapos.ft.mp _ _, exact (ft.mp _ _ (ft.p1 _ _) iden)
-- end
...
lemma imp_and {form: Type} {ft: formula form} {φ ψ : form}:
